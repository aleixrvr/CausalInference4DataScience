...
df_observed <- df_all[, c('id', 'time_points', 'D', 'Y')]
```
...
# ggsave('../../../images/ch11-dids_observed.png', res_plot)
res_plot
```
...
res_plot
# ggplot(df_observed, aes(time_points, Y, color=as.factor(D))) +
#   geom_point() +
#   stat_summary(
#     aes(time_points, Y, group=as.factor(D)),
#     geom = "point",
#     fun.y = "mean",
#     col = "black"
#   )
...
ggsave('../../../images/ch11-dids_counterfactual.png', res_plot)
res_plot
```
...
ggsave('../../../images/ch11-dids_atet.png', res_plot)
res_plot
```
