...
ggsave('../../../images/ch11-seasonality.png', res_plot)
res_plot
```
...
ggsave('../../../images/ch11-rdd_observed.png', res_plot)
res_plot
```


Let's check that the impact is correct. It should coincide with the maximum value of the difference of the time series `r max(abs(Y_0-Y_1))`
...
ggsave('../../../images/ch11-rdd_potential_outcomes.png', res_plot)
res_plot
```
...
ggsave('../../../images/ch11-mean_evolution.png', res_plot)
res_plot
```
...
ggsave('../../../images/ch11-rdd_linear.png', res_plot)
res_plot
```
...
ggsave('../../../images/ch11-linear_evolution.png', res_plot)
res_plot
```
...
```{r}
z <- seq(-2, 2, 0.01)
y <- ifelse(abs(z) < 1, 1, 0)
res_plot <- qplot(z, y)

ggsave('../../../images/ch11-uniform.png', res_plot)
res_plot
```

```{r}
z <- seq(-2, 2, 0.01)
y <- ifelse(abs(z) < 1, 1 - abs(z), 0)
res_plot <- qplot(z, y)

ggsave('../../../images/ch11-triangular.png', res_plot)
res_plot
```
