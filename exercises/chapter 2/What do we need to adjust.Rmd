...
- $P(O=1|T=1) - P(O=1|T=0)$ = `r mean(outcome[treatment==1]) - mean(outcome[treatment==0])`
- $\mbox{adjustment}(1) - \mbox{adjustment}(0)$ = `r adjustment(treatment, outcome, confounder, 1) - adjustment(treatment, outcome, confounder, 0)`
- ATE = 0.3 - 0.5 = -0.2
...
- $P(O=1|T=1) - P(O=1|T=0)$ = `r mean(outcome[treatment==1]) - mean(outcome[treatment==0])`
- $\mbox{adjustment}(1) - \mbox{adjustment}(0)$= `r adjustment(treatment, outcome, mediator, 1) - adjustment(treatment, outcome, mediator, 0)`
...
- $P(O=1|T=1) - P(O=1|T=0)$ = `r mean(outcome[treatment==1]) - mean(outcome[treatment==0])`
- $\mbox{adjustment}(1) - \mbox{adjustment}(0)$= `r adjustment(treatment, outcome, predictor, 1) - adjustment(treatment, outcome, predictor, 0)`
- ATE = 0.4 - 0.5 = -0.1
